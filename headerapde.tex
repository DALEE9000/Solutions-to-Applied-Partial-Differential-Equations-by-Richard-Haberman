...
\author{\nbook \\ \small Richard Haberman \\ \small Solutions by \nauthor}
\date{}
...
%%%%%%%%%%%%%%%%%%%%
% Moved here from the individual chapter documents, which each carried an
% identical copy, so that every document (chapters and the merged manual) picks
% up the same settings from one place.
